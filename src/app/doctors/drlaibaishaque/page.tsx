...
export const metadata = {
  title: "Dr. Laiba Ishaque | Dr. Babur & Associates",
  description:
    "Learn more about Dr. Laiba Ishaque, her qualifications, clinical expertise, and approach to dental care.",
};
...
const qualifications = [
  ...
  {
    title: "Lecturer",
    description: "Department of Orthodontics, Fatima Jinnah Dental College & Hospital",
  },
];
...
const experience = [
  ...
  },
  {
    period: "Present",
    role: "Lecturer",
    organization: "Department of Orthodontics, Fatima Jinnah Dental College & Hospital",
  },
];

export default function DrLaibaIshaquePage() {
  return (
      ...
      <section className="relative overflow-hidden border-b border-black/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-12 pt-32 sm:px-8 sm:pb-16 sm:pt-36 lg:px-10 lg:pb-20 lg:pt-40">
          ...
          <div className="mb-10 flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-black/35">
            ...
            <span>/</span>
            <span className="text-black/60">Dr. Laiba Ishaque</span>
          </div>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div className="relative mx-auto w-full max-w-[480px] lg:mx-0">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[28px] bg-[#EEF2F6]">
                <Image
                  src="/assets/doctors/Dr Laiba Ishaq.png"
                  alt="Dr. Laiba Ishaque"
                  fill
                  priority
              ...
              <div className="absolute bottom-5 left-5 rounded-2xl border border-white/20 bg-black/80 px-5 py-4 text-white backdrop-blur-md">
                ...
                <p className="mt-1 text-sm font-medium">8+ Years</p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-5 text-base font-medium text-black/60">
                General Dentist & Lecturer in Orthodontics
              </p>

              <p className="mt-5 max-w-xl text-sm leading-7 text-black/45 sm:text-base">
                Dr. Laiba Ishaque is a passionate general dentist committed to 
                delivering personalized and high-quality dental care. She also 
                serves as a lecturer at the Department of Orthodontics, Fatima 
                Jinnah Dental College and Hospital, where she shares her 
                expertise with the next generation of dentists.
              </p>
      ...
      >
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20">
          ...
          <div className="max-w-3xl space-y-5 text-sm leading-7 text-black/55 sm:text-base">
            <p>
              Dr. Laiba Ishaque is a dedicated general dentist with a deep 
              commitment to providing personalized, high-quality dental care. 
              Her approach is rooted in understanding each patient's unique 
              needs and delivering treatment that prioritizes both health and 
              comfort.
            </p>
            <p>
              In addition to her clinical work at Dr. Babur &amp; Associates, 
              Dr. Laiba serves as a lecturer at the Department of Orthodontics, 
              Fatima Jinnah Dental College and Hospital. Her academic role 
              allows her to stay at the forefront of dental education and 
              share her knowledge with future dental professionals.
            </p>
            <p>
              She believes in creating a positive and supportive environment 
              for her patients, ensuring they feel informed and confident 
