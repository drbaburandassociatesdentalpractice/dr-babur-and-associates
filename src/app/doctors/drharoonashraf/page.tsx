...
export const metadata = {
  title: "Dr. Haroon Ashraf | Dr. Babur & Associates",
  description:
    "Learn more about Dr. Haroon Ashraf, his qualifications, clinical expertise, and approach to dental care.",
};
...
const qualifications = [
  {
    title: "BDS",
    description: "Graduate of Baqai Medical University, 2009",
  },
  {
    title: "FCPS",
    description: "Fellow of College of Physicians and Surgeons Pakistan, 2019",
...
const experience = [
  {
    period: "2011 - Present",
    role: "General Dentist & Restorative Consultant",
    organization: "Dr. Babur & Associates, Karachi",
  },
  {
    period: "2019",
    role: "FCPS in Operative Dentistry",
    organization: "College of Physicians and Surgeons Pakistan",
  },
];

export default function DrHaroonAshrafPage() {
  return (
      ...
      <section className="relative overflow-hidden border-b border-black/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-12 pt-32 sm:px-8 sm:pb-16 sm:pt-36 lg:px-10 lg:pb-20 lg:pt-40">
          ...
          <div className="mb-10 flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-black/35">
            ...
            <span>/</span>
            <span className="text-black/60">Dr. Haroon Ashraf</span>
          </div>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div className="relative mx-auto w-full max-w-[480px] lg:mx-0">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[28px] bg-[#EEF2F6]">
                <Image
                  src="/assets/doctors/Dr Haroon Ashraf.png"
                  alt="Dr. Haroon Ashraf"
                  fill
                  priority
            ...
            <div>
              ...
              <p className="mt-5 text-base font-medium text-black/60">
                Restorative Consultant & General Dentist
              </p>

              <p className="mt-5 max-w-xl text-sm leading-7 text-black/45 sm:text-base">
                A graduate of Baqai Medical University (2009), Dr. Haroon Ashraf 
                completed his FCPS from CPSP in 2019 in the field of Operative 
                Dentistry. Since 2011, he has been an integral part of our team 
                as a general dentist with excellent skills in root canals and 
                fillings.
              </p>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-[#6E9CCE]/10 px-3 py-1.5 text-[10px] font-medium text-[#6E9CCE]">
      ...
      >
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20">
          ...
          <div className="max-w-3xl space-y-5 text-sm leading-7 text-black/55 sm:text-base">
            <p>
              Dr. Haroon Ashraf is a highly skilled restorative consultant and 
              general dentist who has been an integral part of our team since 
              2011. A graduate of Baqai Medical University (2009), he completed 
              his FCPS from CPSP in 2019 in the field of Operative Dentistry.
            </p>
            <p>
              With over 15 years of clinical experience, Dr. Haroon specializes 
              in advanced root canal treatments, cosmetic fillings, smile 
              designing, and complex restorative procedures. His expertise 
              also extends to pediatric dentistry, making him a versatile 
              practitioner for patients of all ages.
            </p>
            <p>
              Known for his exceptional skills in restorations, Dr. Haroon 
              takes pride in delivering natural-looking, long-lasting results. 
              He is widely recognized as the best restorative consultant, 
              combining technical precision with an artistic eye for aesthetics.
            </p>
          </div>
        </div>
      </section>
              ...
              {qualifications.map((item, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    {item.specialty && (
                      <p className="mt-0.5 text-[10px] font-medium text-[#6E9CCE]">
                        {item.specialty}
                      </p>
                    )}
                  </div>
