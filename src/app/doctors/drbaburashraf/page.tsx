...
export const metadata = {
  title: "Dr. Babur Ashraf | Dr. Babur & Associates",
  description:
    "Learn more about Dr. Babur Ashraf, his qualifications, clinical expertise, and approach to dental care.",
};
...
const qualifications = [
  ...
  },
  {
    ...
    description: "Add specific training or certification here",
  },
];
...
const experience = [
  {
    ...
    organization: "Dr. Babur & Associates",
  },
  {
    period: "Previous",
    role: "Dental Practitioner",
    organization: "Add previous organization",
  },
];

export default function DrBaburAshrafPage() {
  return (
      ...
      <section className="relative overflow-hidden border-b border-black/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-12 pt-32 sm:px-8 sm:pb-16 sm:pt-36 lg:px-10 lg:pb-20 lg:pt-40">
          ...
          <div className="mb-10 flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-black/35">
            ...
            <span>/</span>
            <span className="text-black/60">Dr. Babur Ashraf</span>
          </div>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div className="relative mx-auto w-full max-w-[480px] lg:mx-0">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[28px] bg-[#EEF2F6]">
                <Image
                  src="/assets/doctors/Dr Babur Ashraf.png"
                  alt="Dr. Babur Ashraf"
                  fill
                  priority
            ...
            <div>
              ...
              <p className="mt-5 max-w-xl text-sm leading-7 text-black/45 sm:text-base">
                Dr. Babur Ashraf is a highly skilled Orthodontist and General Dentist 
                with extensive experience in creating beautiful, confident smiles. 
                He specializes in braces, aligners, and comprehensive dental care 
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20">
          <div>
            ...
            <h2 className="mt-3 max-w-sm text-3xl font-light leading-tight tracking-[-0.04em] text-black sm:text-4xl">
              Dentistry built around people.
            </h2>
          </div>

          <div className="max-w-3xl space-y-5 text-sm leading-7 text-black/55 sm:text-base">
            <p>
              Dr. Babur Ashraf is a dedicated orthodontist and general dentist 
              with over 15 years of experience. He completed his BDS from a 
              prestigious institution and has advanced training in orthodontics.
            </p>
            <p>
              His philosophy centers on patient comfort, clear communication, 
              and evidence-based treatment. He takes time to understand each 
              patient's unique needs and goals before recommending treatment.
            </p>
            <p>
              At Dr. Babur &amp; Associates, he provides comprehensive orthodontic 
              and general dental care, from braces and aligners to preventive 
