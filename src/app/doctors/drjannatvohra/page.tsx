...
export const metadata = {
  title: "Dr. Jannat Vohra | Dr. Babur & Associates",
  description:
    "Learn more about Dr. Jannat Vohra, her qualifications, clinical expertise, and approach to dental care.",
};
...
const qualifications = [
  ...
  {
    title: "Facial Aesthetics Training",
    description: "Advanced training in facial aesthetics and cosmetic procedures",
  },
];
...
export default function DrJannatVohraPage() {
  return (
      ...
      <section className="relative overflow-hidden border-b border-black/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-12 pt-32 sm:px-8 sm:pb-16 sm:pt-36 lg:px-10 lg:pb-20 lg:pt-40">
          ...
          <div className="mb-10 flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-black/35">
            ...
            <span>/</span>
            <span className="text-black/60">Dr. Jannat Vohra</span>
          </div>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div className="relative mx-auto w-full max-w-[480px] lg:mx-0">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[28px] bg-[#EEF2F6]">
                <Image
                  src="/assets/doctors/Dr Jannat Vohra.png"
                  alt="Dr. Jannat Vohra"
                  fill
                  priority
              ...
              <div className="absolute bottom-5 left-5 rounded-2xl border border-white/20 bg-black/80 px-5 py-4 text-white backdrop-blur-md">
                ...
                <p className="mt-1 text-sm font-medium">7+ Years</p>
              </div>
            </div>
            ...
            <div>
              ...
              Dr. Jannat Vohra graduated from Dow University of Health Sciences 
              in 2018 and has 7 years of clinical experience in general and 
              cosmetic dentistry. With additional training in facial aesthetics, 
              she takes a comprehensive approach to enhancing both oral health 
              and aesthetics, while ensuring every patient feels comfortable 
              and cared for.
              </p>
      ...
      >
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.65fr_1.35fr] lg:gap-20">
          ...
          <div className="max-w-3xl space-y-5 text-sm leading-7 text-black/55 sm:text-base">
            <p>
              Dr. Jannat Vohra is a dedicated General and Cosmetic Dentist who 
              graduated from Dow University of Health Sciences in 2018. With 7 
              years of clinical experience, she has developed a reputation for 
              providing compassionate, patient-centered care.
            </p>
            <p>
              Her philosophy centers on the belief that a healthy smile is a 
              confident smile. She takes a comprehensive approach to dentistry, 
              combining restorative treatments with aesthetic enhancements to 
              achieve optimal results for her patients.
            </p>
            <p>
              With additional training in facial aesthetics, Dr. Jannat offers 
              a holistic approach to dental care. She ensures every patient 
              feels comfortable, informed, and valued throughout their treatment 
              journey.
            </p>
          </div>
        </div>
